#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=16640&xmax=16959&ymin=24256&ymax=24447&zoom=16&scale=256&tiles=mapnik

import io, urllib2, datetime, time, re, random
from PIL import Image, ImageDraw
# ^^^^^^ install "python-pillow" package | pip install Pillow | easy_install Pillow

(zoom, xmin, ymin, xmax, ymax) = (16, 16640, 24256, 16959, 24447)
